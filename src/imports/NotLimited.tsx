...
export default function NotLimited() {
    return (
        <div className="bg-[#F1E9DA] w-full overflow-x-hidden relative">
            ...
            <div
                className="hidden md:block z-0 absolute bg-[#f1e9da] h-[4047px] left-0 right-0 overflow-clip md:top-[300px] lg:top-[500px] xl:top-[700px]"
    ...
    ">
            ...
            <section
                ...
                <div className="w-full max-w-[1140px] 2xl:scale-[1.5] grid grid-cols-3 gap-[20px]">
                    ...
                    {/* row 3 */}
                    <HoverVideo img={img6} video="/compressed_1.mp4" className="h-[652px]"/>
                    <HoverVideo img={img7} video="/vid6-compressed.mp4" className="h-[652px]"/>
                    <HoverVideo img={img8} video="/compressed_3.MP4" className="h-[652px]"/>

                    {/* bottom feature */}
                    <HoverVideo img={img9} video="/compressed_2.mp4" className="col-span-3 h-[640px]"/>
